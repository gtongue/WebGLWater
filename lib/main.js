...
export default class Main {
  ...
  constructor(GL){
    ...
    this.camera = new Camera([0,8,27],[0,0,0],[0,1,0]);
    ...
    this.waterShader = new ShaderProgram(waterVS, waterFS, ["color", "time", "amplitude", "wavelength", "frequency"], ["position", "normal"], GL);
