export const generatePlane = (width = 200, height = 200, offset = .1) => {
  ...
  currentIndexLength = vertices.length / 3;    
  for(let i = 0; i <= width; i++){
  ...
  for(let i = 0; i < height; i++){
    for(let j = (width)*i + i; j < (width)*i + (width + i); j++){
      indices.push(j + currentIndexLength);
      indices.push(j+1 + currentIndexLength);
      indices.push(j+width+1 + currentIndexLength);
      indices.push(j+1 + currentIndexLength);
      indices.push(j+2+width + currentIndexLength);
      indices.push(j+1+width + currentIndexLength);
    }
  }
